...
export function IconStop({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
...
export function IconTerminal({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <path d="M4 17 10 12 4 7M12 19h8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconChevron({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
...
export function IconShield({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden>
      <path d="M12 3 5 6v6c0 5 3.2 7.6 7 9 3.8-1.4 7-4 7-9V6z" strokeLinejoin="round" />
    </svg>
  );
}
